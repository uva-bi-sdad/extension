...
data_rural <- read_rds("data/ruralapp.rds")
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(menuItem(text = "Home", 
                ...
                menuItem(startExpanded = F,
                         text = "Rurality", 
                         icon = icon("info-circle"),
                         menuSubItem(text = "County Rurality", tabName = "rural", icon = NULL)),
                hr(),
                menuItem(startExpanded = F,
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "rural",
              fluidRow(style = "margin: 6px;",
                       h3(strong("Exploring Virginia County Rurality"), align = "left", style = "margin-left: 17px; margin-bottom: 0px;"),
                       br(),
                       box(width = 12,
                           fluidRow(
                             column(width = 1,
                             ...
                             column(width = 11,
                                    "The tool below allows you to compare the rural status of Virginia's counties according to multiple available delineations.", 
                                    p(), 
                                    "This dashboard uses Virginia Department of Health Office of Rural Health's definition of county rurality.",
                                    br(),
                                    "Use the navigation tabs to explore", strong("Virginia counties' rural status"), "according to this and other available definitions.",
                                    p(),
                                    "All information is mapped at the county level. Data by county and all rurality definitions are provided under the maps.", 
                                    br(),
                                    "Hover over a county to view its rural status according to the definitions included here.")
                           )
                       ),
                       h4(strong("Maps"), style = "margin-left: 17px;"),
                       ...
                       tabsetPanel(
                         tabPanel("Rural-Urban Type",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: Virginia Department of Health Office of Rural-Urban Definition')),
                                    p(),
                         ...
                         tabPanel("Metropolitan/Nonmetropolitan Delineation",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: US Office of Management and Budget Metropolitan/Nonmetropolitan Delineation')),
                                    p(),
                         ...
                         tabPanel("Index of Relative Rurality",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: Purdue Index of Relative Rurality Definition')),
                                    p(),
                         ...
                         tabPanel("Rural-Urban Continuum Code",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: USDA Rural-Urban Continuum Code Definition')),
                                    p(),
                         ...
                         tabPanel("Urban Influence Code",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: USDA Urban Influence Codes Definition')),
                                    p(),
                         ...
                         tabPanel("Rural-Urban Density Typology",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: Isserman Rural-Urban Density Typology Definition')),
                                    p(),
                         ...
                         tabPanel("Urban-Rural Classification Scheme",
                                  fluidRow(
                                    style = "margin: 17px",
                                    h5(strong('County-Level Rurality: National Center for Health Statistics Urban-Rural Classification Scheme Definition')),
                                    p(),
              ...
              fluidRow(style = "margin: 17px;",
                       hr(),
                       h4(strong("Data"), style = "margin-left: 17px;"),
              ...
              fluidRow(style = "margin: 17px;",
                       hr(),
                       h4(strong("Sources"), style = "margin-left: 17px;"),
...
server <- function(input, output){
  ...
  ruraltable <- reactive({
    ...
    data_rural %>% st_set_geometry(NULL) %>%
  ...
  output$plot_nchs <- renderLeaflet({
    create_plot_factor(data_rural$nchs_2013, "Urban-Rural Classification<br>Scheme")
  })
  
  output$plot_srhp <- renderLeaflet({
    create_plot_factor(data_rural$srhprurality, "VDH ORH Classification")
  })
  
  output$plot_omb <- renderLeaflet({
    create_plot_factor(data_rural$ombrural, "Metropolitan/Nonmetropolitan<br>Delineation")
  })
  
  output$plot_isser <- renderLeaflet({
    create_plot_factor(data_rural$isserman, "Isserman Classification")
  })
  
  output$plot_rucc <- renderLeaflet({
    create_plot_factor(data_rural$rucc_2013, "Rural-Urban<br>Continuum Code")
  })
  
  output$plot_irr <- renderLeaflet({
    create_plot_cont(data_rural$irr201, "Index of Relative<br>Rurality")
  })
  
  output$plot_urbinf <- renderLeaflet({
    create_plot_factor(data_rural$uic_2013, "Urban Influence<br>Code")
  })
